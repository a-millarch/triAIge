...
from src.custom.custom_fusion_model import TSCNNModel
...
@hydra.main(version_base=None, config_path="../configs/study/cnn", config_name="20min.yaml")
def train_main(cfg:DictConfig):
    ...
    model = TSCNNModel(f.dls.vars, len(f.target), f.dls.len, classes, f.cont_names, #type: ignore
